...
class ProgressesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create progress" do
    assert_difference("Progress.count") do
      post progresses_url, params: { progress: { challenge_id: @progress.challenge_id, points_earned: @progress.points_earned, update_frequency: @progress.update_frequency, user_id: @progress.user_id } }
    end
  ...
  test "should update progress" do
    patch progress_url(@progress), params: { progress: { challenge_id: @progress.challenge_id, points_earned: @progress.points_earned, update_frequency: @progress.update_frequency, user_id: @progress.user_id } }
